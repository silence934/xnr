            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.zhongzhihuId">
                            种植户
                        </span>
...
|| (sessionTable == 'zhongzhihu' && scope.row.zhongzhihuId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xnr/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.zhongzhihuId = el.zhongzhihuId;//---
                            forum.zhongzhihuName = el.zhongzhihuName;
                            forum.zhongzhihuPhoto = el.zhongzhihuPhoto;
                            forum.zhongzhihuPhone = el.zhongzhihuPhone;
                            forum.zhongzhihuIdNumber = el.zhongzhihuIdNumber;
                            forum.zhongzhihuEmail = el.zhongzhihuEmail;
                            forum.newMoney = el.newMoney;
                            forum.createTime = el.createTime;
