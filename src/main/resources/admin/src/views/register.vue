    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">新农人交流论坛系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <el-form-item label="种植户姓名" class="input" v-if="tableName=='zhongzhihu'">
                            <el-input v-model="ruleForm.zhongzhihuName" autocomplete="off" placeholder="种植户姓名"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="zhongzhihuPhotoFlag">
                            </el-form-item>
                            <el-form-item label="头像" class="input" v-if="tableName=='zhongzhihu'">
                                    <file-upload
                                        tip="点击上传头像"
                                        action="file/upload"
                                        :limit="1"
                                        :multiple="true"
                                        :fileUrls="ruleForm.zhongzhihuPhoto?$base.url+ruleForm.zhongzhihuPhoto:''"
                                        @change="zhongzhihuPhotoUploadChange"
                                    ></file-upload>
                           </el-form-item>
                        -->
                        <el-form-item label="种植户手机号" class="input" v-if="tableName=='zhongzhihu'">
                            <el-input v-model="ruleForm.zhongzhihuPhone" autocomplete="off" placeholder="种植户手机号"  />
                        </el-form-item>
                        <el-form-item label="种植户身份证号" class="input" v-if="tableName=='zhongzhihu'">
                            <el-input v-model="ruleForm.zhongzhihuIdNumber" autocomplete="off" placeholder="种植户身份证号"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='zhongzhihu'">
                            <el-input v-model="ruleForm.zhongzhihuEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="余额" class="input" v-if="tableName=='zhongzhihu'">
                                <el-input v-model="ruleForm.newMoney" autocomplete="off" placeholder="余额"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='zhongzhihu'">
                                <el-input v-model="ruleForm.createTime" autocomplete="off" placeholder="创建时间"  />
                           </el-form-item>
                        -->
    ...
    export default {
        data() {
            return {
                ...
                zhongzhihuPhotoFlag:false,//用于刷新文件上传
            };
        },
        mounted(){
        ...
        methods: {
            ...
            zhongzhihuPhotoUploadChange(fileUrls) {
               this.ruleForm.zhongzhihuPhoto = fileUrls;
                if(this.zhongzhihuPhotoFlag){
                    this.zhongzhihuPhotoFlag=false;
                }else{
                    this.zhongzhihuPhotoFlag=true;
                }
            },
            close(){
            ...
            login() {
                            ...
                            //     return
                            // }
                            if((!this.ruleForm.zhongzhihuName)&& 'zhongzhihu'==this.tableName){
                                this.$message.error('种植户姓名不能为空');
                                return
                            }
                            // zhongzhihu 中的 头像 判空处理
                            // if('zhongzhihu' == this.tableName && (this.ruleForm.zhongzhihuPhoto== null ||this.ruleForm.zhongzhihuPhoto== "")){
                            //     this.$message.error("头像不能为空");
                            //     return
                            // }
                             if('zhongzhihu' == this.tableName && this.ruleForm.zhongzhihuPhone&&(!this.$validate.isMobile(this.ruleForm.zhongzhihuPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.zhongzhihuIdNumber)&& 'zhongzhihu'==this.tableName){
                                this.$message.error('种植户身份证号不能为空');
                                return
                            }
                            if('zhongzhihu' == this.tableName && this.ruleForm.zhongzhihuEmail&&(!this.$validate.isEmail(this.ruleForm.zhongzhihuEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                            // zhongzhihu 中的 余额 判空处理
                            // if('zhongzhihu' == this.tableName && (this.ruleForm.newMoney== null ||this.ruleForm.newMoney== "")){
                            //     this.$message.error("余额不能为空");
                            //     return
                            // }
                            // zhongzhihu 中的 创建时间 判空处理
                            // if('zhongzhihu' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
                            //     this.$message.error("创建时间不能为空");
                            //     return
                            // }
                this.$http({
