    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(cart !=null){
            ...
            //级联表 农产品
            //级联表
            ChanpinEntity chanpin = chanpinService.selectById(cart.getChanpinId());
            if(chanpin != null){
    ...
    */
    ...
    public R save(@RequestBody CartEntity cart, HttpServletRequest request){
        ...
        Wrapper<CartEntity> queryWrapper = new EntityWrapper<CartEntity>()
            ...
            .eq("chanpin_id", cart.getChanpinId())
...
//                            cartEntity.setChanpinId(Integer.valueOf(data.get(0)));   //农产品 要改的
