...
public class ChanpinCommentbackEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ChanpinCommentbackEntity() {

	}

	public ChanpinCommentbackEntity(T t) {
    ...
    @TableField(value = "chanpin_commentback_text")
    ...
    public String toString() {
        return "ChanpinCommentback{" +
            ", id=" + id +
            ", chanpinId=" + chanpinId +
            ", yonghuId=" + yonghuId +
            ", chanpinCommentbackText=" + chanpinCommentbackText +
