...
public class ForumController {
    ...
    @Autowired
    private ForumDianzanService forumDianzanService; //帖子点赞
    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            if(yonghu != null){
            BeanUtils.copyProperties( yonghu , view , "id", "createTime", "insertTime", "updateTime", "yonghuId"
                    , "zhongzhihuId"
            ...
            //级联表 种植户
            //级联表
            ZhongzhihuEntity zhongzhihu = zhongzhihuService.selectById(forum.getZhongzhihuId());
            if(zhongzhihu != null){
            BeanUtils.copyProperties( zhongzhihu , view , "id", "createTime", "insertTime", "updateTime", "yonghuId"
                    , "zhongzhihuId"
                    , "usersId");//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            ...
            wrapper=new EntityWrapper<>(dianzan);
            count=forumDianzanService.selectCount(wrapper);
            view.setDianzanEd(count>0);
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setZhongzhihuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("zhongzhihu_id", forum.getZhongzhihuId())
...
//                            forumEntity.setZhongzhihuId(Integer.valueOf(data.get(0)));   //种植户 要改的
